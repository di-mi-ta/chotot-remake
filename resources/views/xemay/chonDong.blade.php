...
<form action="{{url('xem-lai-tin-ban-xe-may')}}"  method="POST"  role="form" name="form9">
  {{ csrf_field()}}
	    ...
	    <div class="luan-panel luan-panel-default">
	        <div class="form-group" style="margin:0px; width: 100%;">
		        ...
		        <div class="danh-muc-dang-tin">
		        	<input id="hidden-input-common" type="hidden" name="dongxemay" value="">
		        	<?php
		            	foreach($dongxemay as  $value){
