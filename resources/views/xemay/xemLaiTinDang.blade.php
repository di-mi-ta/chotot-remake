...
<div class="container-final-form">
    ...
    <form action="{{url('dang-tin-xe-may')}}"  method="POST"  role="form">
  {{ csrf_field()}}
...
<div class="panel-default love-div">
        ...
        <input type="text" for="sel1" readonly="true" value="<?php echo Session::get('hsxxemay');?>">
</div>

<div class="panel-default love-div">
        <label for="sel1">Dòng xe</label> 
        <input type="text" for="sel1" readonly="true" value="<?php echo Session::get('dongxemay');?>">
</div>
